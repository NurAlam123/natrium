...
const NameAndAddress = () => {
  return (
    <div>
      ...
      <h1 className="font-bebas-neue font-semibold text-center not-italic sm:text-[64px] text-[81px] md:text-[258px] tracking-wider text-secondary !leading-tight [font-display:swap] overflow-hidden">
